...
function catix_woocommerce_scripts() {
	wp_enqueue_style( 'catix-woocommerce-style', get_template_directory_uri() . '/woocommerce.css', array(), _S_VERSION );
...
if ( ! function_exists( 'catix_woocommerce_cart_link' ) ) {
	...
	function catix_woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'catix' ); ?>">
			<?php
